...
import net.minecraft.client.render.RenderPhase.Textures.Builder;
...
public abstract class RenderPhase {
	...
	public static final RenderPhase.Transparency GLINT_TRANSPARENCY = new RenderPhase.Transparency("glint_transparency", () -> {
		RenderSystem.enableBlend();
		RenderSystem.blendFuncSeparate(SrcFactor.SRC_COLOR, DstFactor.ONE, SrcFactor.ZERO, DstFactor.ONE);
	}, () -> {
		RenderSystem.disableBlend();
		RenderSystem.defaultBlendFunc();
	});
	public static final RenderPhase.Transparency CRUMBLING_TRANSPARENCY = new RenderPhase.Transparency("crumbling_transparency", () -> {
		RenderSystem.enableBlend();
		RenderSystem.blendFuncSeparate(SrcFactor.DST_COLOR, DstFactor.SRC_COLOR, SrcFactor.ONE, DstFactor.ZERO);
	}, () -> {
		RenderSystem.disableBlend();
		RenderSystem.defaultBlendFunc();
	});
	...
	public static final RenderPhase.ShaderProgram CLOUDS_PROGRAM = new RenderPhase.ShaderProgram(GameRenderer::getRenderTypeCloudsProgram);
	...
	public static final RenderPhase.ShaderProgram BREEZE_WIND_PROGRAM = new RenderPhase.ShaderProgram(GameRenderer::getRenderTypeBreezeWindProgram);
	...
	public static class Texture extends RenderPhase.TextureBase {
		public final Optional<Identifier> id;
